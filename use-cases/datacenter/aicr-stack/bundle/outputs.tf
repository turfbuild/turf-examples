...
output "namespaces" {
  ...
  value       = distinct(["agentgateway-system", "cert-manager", "agentgateway-system", "node-feature-discovery", "nvidia-network-operator", "skyhook", "monitoring", "monitoring", "gpu-operator", "monitoring", "kai-scheduler", "nvidia-dra-driver", "nvsentinel", "monitoring"])
}
